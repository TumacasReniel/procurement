...
:global([data-layout-mode="dark"] .inv-module-card){
  --inv-brand-soft: #1a2540; --inv-border: #2e3a59; --inv-surface: #111827;
  --inv-muted: #9ca9c7; --inv-ink: #e5e7eb;
}
...
:global([data-layout-mode="dark"] .inv-action-btn){
  background: #151e33; border-color: var(--inv-border); color: var(--inv-ink);
}
:global([data-bs-theme="dark"] .inv-icon-btn:hover),
:global([data-layout-mode="dark"] .inv-icon-btn:hover){
  background: #1a2540; color: #8ea0f4;
}
...
:global([data-layout-mode="dark"] .inv-count-badge){
  background: rgba(142, 160, 244, 0.14); border-color: rgba(142, 160, 244, 0.28); color: #8ea0f4;
}
:global([data-bs-theme="dark"] .inv-pagination-bar),
:global([data-layout-mode="dark"] .inv-pagination-bar){
  background: #111827; border-top-color: var(--inv-border);
}
:global([data-bs-theme="dark"] .inv-action-btn.view:hover),
:global([data-layout-mode="dark"] .inv-action-btn.view:hover){
  background: rgba(56, 189, 248, 0.14); border-color: #38bdf8; color: #38bdf8;
}
:global([data-bs-theme="dark"] .inv-action-btn.edit:hover),
:global([data-layout-mode="dark"] .inv-action-btn.edit:hover){
  background: rgba(245, 158, 11, 0.14); border-color: #f59e0b; color: #fbbf24;
}
:global([data-bs-theme="dark"] .inv-action-btn.del:hover),
:global([data-layout-mode="dark"] .inv-action-btn.del:hover){
  background: rgba(248, 113, 113, 0.14); border-color: #f87171; color: #f87171;
}
</style>
