<template>
  ...
  <PageHeader title="Creditors" pageTitle="List" />
  <BRow>
    <div class="col-md-12">
          ...
          <div class="d-flex mb-n3">
            <div class="flex-shrink-0 me-3">
              <div style="height: 2.5rem; width: 2.5rem">
                <span class="avatar-title bg-warning-subtle rounded p-2 mt-n1">
                  <i class="ri-user-line text-warning fs-24"></i>
                </span>
              </div>
            </div>
            <div class="flex-grow-1">
              <h5 class="mb-0 fs-14">
                <span class="text-body">Creditors</span>
              </h5>
              <p class="text-muted text-truncate-two-lines fs-12">
                Manage creditors and details.
              </p>
            </div>
            ...
            <table class="table align-middle table-hover mb-0">
              ...
              <tbody class="table-group-divider">
                <tr v-if="lists.length === 0">
                  <td colspan="5" class="p-0">
                    <div class="empty-state">
                      ...
                      <div class="empty-state-text">No creditor found.</div>
                    </div>
                  </td>
                </tr>
                <tr
                ...
                >
                  ...
                  <td class="fw-monospace">{{ list.account_code }}</td>
                  <td>
<span class="badge badge-outline-success fs-11">{{ list.creditorable ? list.creditorable.type : 'Standalone' }}</span>
                  </td>
...
import Create from "@/Pages/Modules/FAIMS/Finance/Creditors/Modals/Create.vue";
...
export default {
  ...
  methods: {
    ...
    fetch(page_url) {
      page_url = page_url || "/faims/finance-creditors";
      axios
        .get(page_url, {
          params: {
    ...
    openDelete(id) {
      this.$swal({
        ...
        if (result.isConfirmed) {
          axios.delete(`/faims/finance-creditors/${id}`).then(() => {
            this.fetch();
