<template>
  <Head title="Users" />
  <PageHeader title="Document Management" pageTitle="List" />
  <BRow>
    <div class="col-md-12">
        ...
        <div class="card-header bg-light-subtle">
          <div class="d-flex mb-n3">
            ...
            <div class="flex-grow-1">
              <h5 class="mb-0 fs-14">
                <span class="text-body">Document Management</span>
              </h5>
              <p class="text-muted text-truncate-two-lines fs-12">
                Manage user document and permissions.
              </p>
            </div>
                ...
                <tr v-if="lists.length === 0">
                  <td colspan="5" class="p-0">
                    <div class="empty-state">
                      ...
                      <div class="empty-state-text">No document found.</div>
                    </div>
                  </td>
                </tr>
                <tr
...
import Create from "@/Pages/Modules/FAIMS/Finance/Documents/Modals/Create.vue";
...
export default {
  ...
  methods: {
    ...
    fetch(page_url) {
      page_url = page_url || "/faims/finance-documents";
      axios
        .get(page_url, {
          params: {
